...
%%
%%% Plot for min, eucledian vs cone angle
figure
plot(alpha, min_p2pdist,  'LineWidth', 2)
xlabel('Cone Angle (deg)');
ylabel('Minimum Euclidean Norm Error (ND)');
title('Minimum Euclidean Norm Error as a function of \alpha');
